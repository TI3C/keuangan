...
<?php echo form_open(base_url().'penjualan_masuks/editpenjualan/'.$this->uri->segment(3)); ?>
<div class="">
<table class="table">
	<tr>
    	<!--<td>
...
?></center></td>
    ...
    <tr>
    	<td><?php
    	$tgl = date("d",strtotime($terserah['Tanggal_Penjualan_Masuk']));
    	$bln = date("m",strtotime($terserah['Tanggal_Penjualan_Masuk']));
    	$thn = date("Y",strtotime($terserah['Tanggal_Penjualan_Masuk']));
$options=array(
	''=>'Tgl',
	'1'=>'1',
	'2'=>'2',
