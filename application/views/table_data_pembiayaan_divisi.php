<table class="table">
<?php echo form_open(base_url().'pembiayaan_divisis/datapembiayaan'); ?>
	<!-- <tr>
...
<table class="table table-striped table-hover">
	<tr>
        ...
        <th><center>ID Pembiayaan</center></th>
        <th><center>Divisi</center></th>
        <th><center>Nominal</center></th>
        <th><center>ID Kepentingan</center></th>
...
?>    
    <?php
	foreach($pembiayaan_divisi as $data){
		echo "<tr>
			<td>" . $i . "</td> 
			<td>" . $data['id_Pembiayaan'] . "</td>
			<td>" . $data['Divisi'] . "</td>
			<td>Rp. " . number_format($data['Nominal'],0,'.','.') . ",00</td>
			<td>" . $data['id_Kepentingan'] . "</td>
			<td>" . $data['Keterangan'] . "</td>
			<td><a href=" . base_url() . "pembiayaan_divisis/editpembiayaan/" . $data['id_Pembiayaan'] . ">Edit</a> |
				<a href=" . base_url() . "pembiayaan_divisis/hapuspembiayaan/" . $data['id_Pembiayaan'] . ">Hapus</a></td>
			</tr>";
			$i++;
	}
	?>
